...
public class VideoFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View myFragmentView = inflater.inflate(R.layout.videofragment, container, false);
		...
		myWebView.loadUrl("http://192.168.1.119:8888/hackathon/web/index.php/graph/movement?date="+cal.get(Calendar.DAY_OF_MONTH)+"/"+cal.get(Calendar.MONTH)+"/"+cal.get(Calendar.YEAR));
